  ...
  return (
    <View style={[styles.carpoolpasses, styles.rectangleLayout]}>
      ...
      <ButtonsSwitch
        ...
        aVenirBackgroundColor="#fff"
        aVenirColor="#0075fd"
        passesBackgroundColor="#0075fd"
        passsColor="#fff"
        onAVenirPress={() => navigation.navigate("CarpoolVenir")}
      />
      <View style={styles.main}>
        <Evaluer onParticiperPress={() => navigation.navigate("Signaler")} />
        <Evaluer
          groupViewMarginTop={8}
          onParticiperPress={() => navigation.navigate("Signaler")}
        />
        <Evaluer
          groupViewMarginTop={8}
          onParticiperPress={() => navigation.navigate("Signaler")}
