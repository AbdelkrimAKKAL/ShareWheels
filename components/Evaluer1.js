...
const Evaluer = ({ groupViewMarginTop, onParticiperPress }) => {
  const evaluerStyle = useMemo(() => {
    return {
  ...
  return (
    <View style={[styles.evaluer, styles.dateFlexBox, evaluerStyle]}>
