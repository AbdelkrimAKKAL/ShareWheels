...
const MesAnnonces = ({
  ...
  const mesAnnoncesStyle = useMemo(() => {
    return {
  ...
  return (
    <View style={[styles.mesannonces, styles.dateFlexBox, mesAnnoncesStyle]}>
      ...
      <View style={[styles.infostrajet, styles.trajetFlexBox]}>
        ...
        <View style={[styles.date, styles.dateFlexBox]}>
          ...
          <Text style={[styles.info3, styles.infoTypo]}>
            {deliveryInfoText}
          </Text>
        </View>
      ...
      <View style={[styles.buttons, styles.buttonsFlexBox]}>
        <View style={[styles.participer, styles.buttonsFlexBox]}>
          <Text style={styles.supprimer}>{cancelButtonText}</Text>
        </View>
      </View>
    </View>
  );
